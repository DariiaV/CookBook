...
struct CookBook2: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case vegetarian, vegan,
             ...
             lowFodmap, weightWatcherSmartPoints,
             gaps, preparationMinutes,
             cookingMinutes, aggregateLikes,
             healthScore, creditsText,
             sourceName, pricePerServing,
